...
class PeopleDetailsController extends ChangeNotifier {
  ...
  void _addBookmark() {
    if (_people != null) {
      final bookmarkedPeople = BookmarkedPeople(bookmarkedDate: DateTime.now(), person: people!);
  ...
  bool _checkIfBookmarked() {
    return _bookmarkService.box.keys.contains("${MediaTypes.person.value}_$peopleID");
  }
